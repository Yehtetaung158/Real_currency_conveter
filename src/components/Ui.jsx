...
const Ui = () => {
  ...
  const [currencyData, setCurrencyData] = useState({
    ...
    if(data){
    console.log(currncyUnit[currencyData.fromCurrency],currncyUnit[currencyData.toCurrency])
    }
  ...
  const handleForm = (e) => {
    e.preventDefault()
    if(data){
        let rate=currncyUnit[currencyData.toCurrency]/currncyUnit[currencyData.fromCurrency]
          ...
          <div className=" flex gap-10 flex-col w-11/12">
            ...
            <div className=" flex gap-2 justify-between bg-blue-300 w-[390px] h-[80px] py-2 rounded-lg">
              <div className=" flex justify-center w-3/7 py-2">
                <select name="fromCurrency" value={currencyData.fromCurrency} onChange={amounthandle} className="w-5/6 px-12 rounded-lg">
              ...
              <div className=" w-3/7 py-2 flex justify-center ">
                <select name="toCurrency" value={currencyData.toCurrency} onChange={amounthandle} className=" w-5/6 px-12 rounded-lg">
 ...
 bg-blue-300 w-[390px] h-[80px] py-2 px-4 items-center rounded-lg"
            >
              ...
              <input name="amount" value={currencyData.amount} onChange={amounthandle} className=" rounded-md w-2/3" type="number" />
            </div>
 ...
 bg-blue-300 w-[390px] h-[120px] py-2 px-4 items-center rounded-lg"
            >
              <div className=" w-4/5 flex justify-center rounded-lg bg-white px-2 py-3">
                {" "}
                <p>{currencyData.amount} {currencyData?.fromCurrency} = {currencyData?.result} {currencyData?.toCurrency}</p>
              </div>
